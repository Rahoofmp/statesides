...
Sign = {
    ...
    initDocumentationCharts: function() {
        if ($('#dailySalesChart').length != 0 && $('#openTicketChart').length != 0) {
            ...
            var animationHeaderChart = new Chartist.Line('#openTicketChart', dataDailySalesChart, optionsDailySalesChart);
        }
    },
