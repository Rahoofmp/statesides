...
(function ($, window, document, undefined) {
    ...
    var pluginName = "multiInput",
        ...
        defaults = {
            ...
            json: false,
            addButtonHtml: '<a class="btn btn-just-icon btn-link btn-github add"><i class="fa fa-plus"></i><div class="ripple-container"></div></a>',
            removeButtonHtml: '<a class="btn btn-just-icon btn-link btn-twitter remove"><i class="fa fa-minus"></i><div class="ripple-container"></div></a>',
             i18n: i18n
        };
        ...
        createElement: function (el, suffix, data) {
            ...
            if (!_this.options.json) {
                ...
                $.each(values, function (key, value) {
                    $("input[name='"+ key +"[]']", cloneWrap).val(value);
                });
            }
