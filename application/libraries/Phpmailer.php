...
class Phpmailer extends CI_PHPMailer {
    ...
    public function send_mail($mail_from, $mail_to, $mail_reply_to, $mail_subject, $mail_body, $mail_altbody, $mail_type = "mail", $smtp_data = array(), $attachments = array(), $stringAttachment='') {
        ...
        $this->addCC( 'delivery@pinetreelane.com', 'admin');  //Who is sending the email
        ...
        if ($stringAttachment) {
            $this->AddStringAttachment($stringAttachment, 'Delivery Details.pdf', 'base64', 'application/pdf');
        }
