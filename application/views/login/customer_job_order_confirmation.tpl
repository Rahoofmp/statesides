                ...
                <div id="accordion" role="tablist">
                    ...
                    <div class="card-collapse">
                        ...
                        <div id="collapseThree" class="collapse show" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                            ...
                            {if $jobs['customer_status']=='pending'}
                            <!-- </div> -->
                            ...
                            {elseif $jobs['customer_status'] == 'rejected'}
                            Verification Status :

                            <span class="badge badge-pill badge-danger">Rejected</span>{elseif $jobs['customer_status'] == 'approved'}
                            Verification Status :<span class="badge badge-pill badge-success">Approved</span>{else}  Verification Status :<span class="badge badge-pill badge-success">{$jobs['customer_status']}</span>{/if}
