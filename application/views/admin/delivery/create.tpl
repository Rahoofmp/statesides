                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <div class="input-group form-control-lg">
                                ...
                                <div class="form-group col-sm-10">
                                    <input type="text"  class="form-control" id="package_name" name="package_name"  placeholder="Package Name / Code"  onClick="autoComplete(this, 'admin', 'autocomplete/package_filter')" autocomplete="Off" value="{set_value('package_name')}" >
                        ...
                        <div class="col-sm-5"> 
                            <div class="togglebutton mt-3">
                                <label>
                                    <input type="checkbox" name="by_package_name" value="on" {set_checkbox('by_package_name', 'on')} >
