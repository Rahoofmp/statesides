...
<style type="text/css">
    ...
    <div class="row "> 
        <div class="col-sm-12 hidden-print"> 
            <div class="text-right">
                ...
                <a class="btn btn-primary pull-right"  href="{base_url()}admin/showroom/create">
    ...
    <script>
        ...
        $('.meeting_code_ajax').select2({
            ...
            ajax: {
                url:'{base_url()}admin/autocomplete/meeting_code_ajax',
        ...
        $('body').on('click', '.edit-sales', function(){
            ...
            function (isConfirm) {
                if (isConfirm) {
                    document.location.href = '{base_url()}' + "admin/showroom/edit-meeting/"+id; 
                } else {
        ...
        $('body').on('click', '.delete-sales', function(){
            ...
            function (isConfirm) {
                if (isConfirm) {
                    document.location.href = '{base_url()}' +"admin/showroom/create/delete/"+id; 
                } else {
                    swal('{lang('text_cancelled')}','{lang('your_content_safe')}', "error");
                }
            });
        ...
        var order = $('#sales_list').DataTable({
            ...
            'ajax': {
                'url':'{base_url()}admin/showroom/get_meeting_list_ajax',
                'type': "POST", 
                'data' : {
                    'type' : '{$post_arr['type']}',
