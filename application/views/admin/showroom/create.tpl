            ...
            <div class="input-group form-control-lg">
                ...
                <div class="col-sm-11">
                    <div class="form-group">
                     ...
                     <select type="text" id="sales_name" class="form-control sales_ajax" name="sales_name">
                         {if $id || $smarty.post.sales_name}
                         <option value="{$post_arr['sales_name']}" selected>{$post_arr['sales_name']}</option>
                         {/if}
                     </select>
...
$(document).ready(function() { 
    ...
    $('.user_ajax').select2({
        ...
        ajax: {
            url:'{base_url()}admin/autocomplete/user_ajax',
