			...
			<div class="card-body  mt-3">
				...
				<div class="col-sm-12">
					<div class="input-group form-control-lg">
						...
						<div class="col-sm-9">
							<div class="form-group">
								<label for="voucher_date" class="bmd-label-floating">Voucher Type </label>
								<select class="selectpicker"data-size="7" data-style="select-with-transition"  name="voucher_type" id="voucher_type">
									<option value="damage" {if $material_data['voucher_type']=="damage"}selected{/if}>Damage</option>
									<option value="loss"  {if $material_data['voucher_type']=="loss"}selected{/if}>Loss</option>
								</select>							
				...
				<div class="col-sm-12">
					<div class="input-group form-control-lg">
						...
						<div class="col-sm-9">
							<div class="form-group">
								<label for="voucher_date" class="bmd-label-floating">Voucher Entered By </label>
								
								<select id="voucher_entered_by" name="voucher_entered_by" class="voucher_entered_by form-control" >
									{if  $material_data['voucher_entered_by']}
									<option value="{$material_data['voucher_entered_by']}">{$material_data['voucher_entered_name']}</option>
									{/if}
								</select>					
				...
				<div class="col-sm-12">
					<div class="input-group form-control-lg">
						...
						<div class="col-sm-9">
							<div class="form-group">
								<label for="voucher_date" class="bmd-label-floating">Damaged/Lost By</label>
								
								<select id="damaged_lost_by" name="damaged_lost_by" class="damaged_lost_by form-control" >
									{if  $material_data['damaged_lost_by']}
									<option value="{$material_data['damaged_lost_by']}">{$material_data['damager_name']}</option>
									{/if}
								</select>					
				...
				<div class="col-sm-12">
					<div class="input-group form-control-lg">
						...
						<div class="col-sm-9">
							<div class="form-group">
								<label for="voucher_date" class="bmd-label-floating">Reported By</label>
								
								<select id="reported_by" name="reported_by" class="reported_by form-control" >
									{if  $material_data['reported_by']}
									<option value="{$material_data['reported_by']}">{$material_data['reported_name']}</option>
									{/if}
								</select>					
								{form_error('reported_by')}
	...
	<script>
		...
		// });
			...
			$('.items_update').on('click', function(){
				...
				$.ajax({
					type:'POST',
					url:"{base_url('admin/item/update-damage-items')}",
					data: { 
...
function remove_material_receipt(material_item_id, issue_id)
{
	...
	$.confirm({
		...
		buttons: {
			confirm: function () {
				document.location.href = '{base_url()}' + "admin/item/remove_damage_item/"+material_item_id+'/'+issue_id;
			},
			cancel: function () {
				$.alert('Canceled!');
			},
