			...
			<div class="card-body  mt-3">
					...
					<div class="input-group form-control-lg">
						...
						<div class="col-sm-9">
							<div class="form-group">
								<label for="voucher_number" class="bmd-label-floating">Return Voucher No </label>
				...
				<div class="col-sm-12">
					<div class="input-group form-control-lg">
						...
						<div class="col-sm-9">
							<div class="form-group">
								<label for="voucher_date" class="bmd-label-floating">Return Voucher Date </label>
					...
					<div class="input-group form-control-lg">
						...
						<div class="col-sm-9">
							<div class="form-group">
								...
								<select id="return_by" name="return_by" class="return_by form-control" >
									{if $smarty.post.return_by}
									<option value="{$smarty.post.return_by}">{$return_by}</option>
									{/if}
								</select>					

								{form_error('return_by')}
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-sm-9">
							<div class="form-group">
								...
								<select id="received_by" name="received_by" class="received_by form-control" >
									...
									<option value="{$smarty.post.received_by}">{$received_by}</option>
									{/if}
								</select>					
							...
							<div class="card-body">  
								...
								<div class="col-sm-12 product-items">
									<div class="row">
										...
										<div class="col-sm-3">
											<div class="form-group">
												<input type="text" class="form-control" id="qty"  name="qty" placeholder="Return Quantity" required> 
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
...
<script>
	...
	$(document).ready(function(){ 
		...
		$('.received_by').select2({
			...
			placeholder: 'Select Receiver Employee',
			ajax: {
		...
		$('.items_update').on('click', function(){
			...
			$.ajax({
				type:'POST',
				url:"{base_url('admin/item/save_return_items')}",
				data: { 
					voucher_date: $('#voucher_date').val(),
					voucher_number: $('#voucher_number').val(),
					return_by: $('#return_by').val(),
			...
			.done(function( response ) {
				url  = '{base_url()}'+'admin/item/return-list';
				if(response.success){
