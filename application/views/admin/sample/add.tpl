                        ...
                        <div class="input-group form-control-lg">
                            ...
                            <div class="col-sm-11">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Name" autocomplete="Off" value="{set_value('name', $edit_item['name'])}" >
                                    {form_error('name')}
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                                ...
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cost" class="form-control" placeholder="Cost" autocomplete="Off" value="{set_value('cost', $edit_item['cost'])}" >
                                            {form_error('cost')}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price" class="form-control" placeholder="Selling Price" autocomplete="Off" value="{set_value('price', $edit_item['price'])}" >
                                            {form_error('price')}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="brand" class="form-control" placeholder="Brand" autocomplete="Off"  value="{set_value('brand', $edit_item['brand'])}" >
                                            {form_error('brand')}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="origin" class="form-control" placeholder="Origin" autocomplete="Off" value="{set_value('origin', $edit_item['origin'])}" >
                                            {form_error('origin')}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paint_code" class="form-control" placeholder="Paint Code" autocomplete="Off" value="{set_value('paint_code', $edit_item['paint_code'])}" >
                                ...
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="size" class="form-control" placeholder="Size" autocomplete="Off" value="{set_value('size', $edit_item['size'])}" >
                                            {form_error('size')}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row"> 
                            <div class="col-lg-6">
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input type="text" name="type" class="form-control" placeholder="Type Of Material" autocomplete="Off" value="{set_value('type', $edit_item['type'])}" >
                                            {form_error('type')}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-group form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="grade" class="form-control" placeholder="Grade" autocomplete="Off" value="{set_value('grade', $edit_item['grade'])}" >
                                            {form_error('grade')}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="input-group form-control-lg">
                            ...
                            <div class="col-sm-10">
                                <select id="supplier" name="supplier" class="supplier_ajax form-control">
                                    {if $id || $smarty.post.supplier}
                                    <option value="{$edit_item['supplier']}">{$edit_item['supplier_name']}</option>
                                    {/if}
                                </select>
                                {form_error('supplier')}
                            </div>
