...
<div class="row "> 
	<div class="col-sm-12 hidden-print"> 
		<div class="text-right">
			...
			<a class="btn btn-primary pull-right"  href="{base_url()}admin/sample/add">
			...
			$.confirm({
				...
				buttons: {
					confirm: function () {
						...
						document.location.href = '{base_url()}' + "admin/sample/add/"+id; 
...
// 		myPrintWindow.document.close();
		myPrintWindow.focus();
		myPrintWindow.print();
		        myPrintWindow.onfocus = function () { setTimeout(function () { myPrintWindow.close(); }, 120); }
