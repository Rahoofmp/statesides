													...
													<div class="input-group form-control-lg">
														...
														<div class="col-sm-10">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="short_description" name="short_description" value="{set_value('short_description')}"  required="true" autocomplete="Off">
													...
													<div class="input-group form-control-lg">
														...
														<div class="col-sm-10">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="estimated_working_hrs" name="estimated_working_hrs" {if $id} value="{$jobs['estimated_working_hrs']}" {else} value="{set_value('estimated_working_hrs')}" {/if} required="true" autocomplete="Off">
													...
													<div class="input-group form-control-lg">
														...
														<div class="col-sm-10">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="actual_working_hrs" name="actual_working_hrs" {if $id} value="{$jobs['actual_working_hrs']}" {else} value="{set_value('actual_working_hrs')}" {/if} required="true" autocomplete="Off">
																{form_error("actual_working_hrs")}
															</div>
														</div>
													</div>
												</div>
										...
										<table class="table table-hover" id="sample-table-1">
											...
											<tbody>
												...
												<tr>
													...
													<td>{$d.time_difference}</td> 												<td>
														Admin: <span class="badge badge-pill badge-success">
															{$d.admin_status}
														</span>

														<span class="clearfix"></span>
														Customer: <span class="badge badge-pill badge-success">{$d.customer_status}</span>

														<span class="clearfix"></span>
														Work: <span class="badge badge-pill badge-success">{$d.work_status}</span>
													</td>
													<!-- <td class="td-actions text-right ">

														<a rel="tooltip" title="Edit" href="javascript:edit_job_order('{$v.enc_id}')" class="btn btn-success btn-link"><i class="material-icons">edit</i></i></a>


														<a rel="tooltip" title="Delete" href="javascript:delete_delivery_note('{$v.enc_id}')" class="btn btn-danger btn-sm"><i class="material-icons">delete</i></a>
													</td> -->
												</tr>
												{/foreach}
											</tbody>
