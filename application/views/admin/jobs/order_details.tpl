								...
								<div class="col-9">
									...
									<div class="media">
										...
										<div class="media-body m-l-20">
											...
											<span class="clearfix"></span>   
											<small>Admin Status:
											{if $job_details['admin_status']=='confirm'} Confirmed
											{elseif $job_details['admin_status']=='pending'}
											Pending
											{else}Rejected
												{/if}
											</small>
											...
											{if $job_details['customer_status']=='confirm'} Confirmed
											{elseif $job_details['customer_status']=='pending'}
											Pending
											{else}Rejected
												{/if}
											</small>
											<span class="clearfix"></span>
											<small>Work Status:
											{if $job_details['work_status']=='confirm'} Confirmed
											{elseif $job_details['work_status']=='pending'}
											Pending
											{else}Rejected
												{/if}
											</small>
					...
					<table class="table">
						...
						<tbody>   
							...
							<tr>
								...
								<td>{$v.actual_working_hrs} Hrs</td> 
							</tr>
							{/foreach}	 
						</tbody>
					</table>
