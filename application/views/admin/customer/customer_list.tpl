					...
					<div class="card-body">
						...
						<div class="form-body">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<select type="text" id="salesman_id" class="form-control salesman_ajax" name="salesman_id">
											{if $post_arr['salesman_id']}
											<option value="{$post_arr['salesman_id']}">{$post_arr['salesman_name']}</option>
											{/if}
										</select>
									</div>
								</div>
								...
								<div class="col-sm-2">
									<button type="submit" class="btn btn-warning pull-right" name="submit" value="reset">
		...
		var order = $('#customer_list').DataTable({
			...
			'ajax': {
				...
				"data" : {
					...
					'salesman_id' : '{$search_arr['salesman_id']}',
				}
