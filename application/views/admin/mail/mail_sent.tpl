    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title ">  {lang('text_sent')}</h4></div>
                <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-mailbox table-hover"> 
                                        ...
                                        <tbody>
                                            ...
                                            {foreach from=$sent_messages item=v}
                                            {$id = $v.id}    
                                            ...
                                            <tr>
                                                ...
                                                <td class="message">
                                                 <form method="post" action="/actions.php/" data-js-validate="true" data-js-highlight-state-msg="true" data-js-show-valid-msg="true">
                                                    ...
                                                    <button class="btn btn-primary payBtn" type="submit" name="confirm" id="{$v.id}">View Message</button>
                                                </form>
                                            ...
                                            <td class="center"> 
                                                <div class="visible-md visible-lg hidden-sm hidden-xs buttons-widget">
                                                    ...
                                                    <a class="btn btn-xs btn-red tooltips" data-placement="top" title="Delete message" data-srcid="{$id}" href="javascript:deleteMessage({$id},'{log_user_type()}','mail-sent')" ><i class="material-icons">close</i></a>
                                                </div>
                                            </td>   
                                        </tr> 
...
<script src="{assets_url('plugins/bootstrap-modal/js/bootstrap-modalmanager.js')}"></script>
<script src="{assets_url('plugins/bootstrap-modal/js/bootstrap-modal.js')}"></script>
