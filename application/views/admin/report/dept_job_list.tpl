				...
				<div class="card-body"> 
					...
					<div class="form-body">
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<select id="department_id" name="department_id" class="department_id form-control" >
					...
					<table class="table" id="example">
						...
						{* <tbody>
							...
							<tr>
								...
								<td>
									Ordered: {$v.date|date_format: "%Y-%m-%d"}
									<span class="clearfix"></span>
									<hr>
									Delivery: {$v.requested_date|date_format: "%Y-%m-%d"}
								</td>
								...
								<td class="td-actions text-right hidden-print">

									<a rel="tooltip" title="Edit" href="" class="btn btn-info btn-link"><i class="material-icons">visibility</i></i></a>
								</td>     
							</tr>
							{/foreach}
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var order = $('#example').DataTable({
			...
			'ajax': {
				'url':'{base_url()}admin/report/get_dept_jobs_ajax',
				"type": "POST",
				"data" : {
			...
			{ data: 'action',
			mRender: function(data, type, row) {  
				var url = '{base_url(log_user_type())}'+'/jobs/order-details/'+ row.enc_job_order_id;
