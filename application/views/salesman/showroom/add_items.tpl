                            ...
                            <div class="input-group form-control-lg">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <textarea name="ad_note" class="form-control ad_note">{$ad_note}</textarea> 
                                        {form_error("ad_note")}
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function addRow (data) { 
        ...
        if(validFrom == true){
            ...
            var rowNode = table.row.add( [
                ...
                data.price,
                    // data.inclusive_vat,
                    '<a href="{assets_url()}images/sample/'+data.item_images+'" target="_blank"><img src="{assets_url()}images/sample/'+data.item_images+'" width="100"; height="100" class="img-thumbnail" target="_blank"></a>',
    ...
    $('.items_update').on('click', function(){
        ...
        .done(function( response ) { 
            url  = "{base_url('salesman/showroom/edit-meeting')}";
            if(response.success){
                ...
                alert("failed");
                (btnVal == 'save') ? (document.location.href = url) : document.location.href = "{base_url('salesman/showroom/create')}";
            }
        }); 
