								...
								<div class="row">
										...
										<div class="input-group form-control-lg">
											...
											<div class="col-sm-10">
												<div class="form-group">
													...
													<input type="text" id="subject" class="form-control" name="subject" value="{$details['subject']}" required autocomplete="off"{if $details['status']=='approved' || $details['status']=='lost_or_win' || $details['status']=='sent'}disabled{/if}>
													{form_error('subject')}
												</div> 
											</div>
										</div>
										...
										<div class="input-group form-control-lg">
											...
											<div class="col-sm-10">
												<div class="form-group">
													...
													<input type="text" name="date" class="form-control datepicker" value="{$details['date']}" {if $details['status']=='approved' || $details['status']=='lost_or_win' || $details['status']=='sent'}disabled{/if}>
													{form_error("date")}
												</div>
											</div>
										</div>
										...
										<div class="input-group form-control-lg">
											...
											<div class="col-sm-10">
												<div class="form-group">
													...
													<select id="customer_name" name="customer_name" class="customer_ajax form-control" {if $details['status']=='approved' || $details['status']=='lost_or_win' || $details['status']=='sent'}disabled{/if}>
										...
										<div class="input-group form-control-lg">
											...
											<div class="col-sm-10">
												<div class="form-group">
													...
													<select id="status" name="status" class="selectpicker" data-style="select-with-transition" title="{$details['status']}" >

														{if $details['status'] == 'draft' || $details['status'] == 'submitted_for_approval'}
									...
									<div class="col-lg-6">
										<div class="input-group form-control-lg">
											...
											<div class="col-sm-10">
												<div class="form-group">
													<select id="payment_terms_id" name="payment_terms_id" class="form-control"{if $details['status']=='approved' || $details['status']=='lost_or_win' || $details['status']=='sent'}disabled{/if}>
										...
										<div class="input-group form-control-lg">
											...
											<div class="col-sm-10">
												<div class="form-group">
													...
													<select id="normal_terms_id" name="normal_terms_id" class="form-control" {if $details['status']=='approved' || $details['status']=='lost_or_win' || $details['status']=='sent'}disabled{/if}>
												...
												<tbody>
													...
													<tr>
														...
														<td class="td-actions text-center ">
															<a rel="tooltip" title="edit"  class="btn btn-success btn-sm edit-progress1"  data-id="{$enc_id}" data-item_id="{$v.id}"><i class="material-icons">edit</i></a>
