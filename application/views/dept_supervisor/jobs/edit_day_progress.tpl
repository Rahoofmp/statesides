...
{form_open('dept_supervisor/jobs/update_day_progress','id="fromDayProgress"')}
...
<input type="hidden" class="form-control" required name="department_id" value="{$department_id}">
